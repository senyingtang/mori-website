              ...
              >
                ...
                <div className="mt-6 flex items-center justify-between gap-3">
                  <Link
                    ...
                    className="inline-flex items-center justify-center rounded-xl border border-white/12 bg-white/5 px-4 py-2 text-sm font-semibold text-white/90 transition hover:bg-white/10"
                  >
                    查看場次
                  </Link>
                  <Link
